                    ...
                    <div class="product-media-section mb-4">
                        ...
                        <div class="main-image-container mb-3">
                            @if ($order->images->isNotEmpty())
                                <img id="main-product-image" src="{{ asset($order->images->first()->image_path) }}"
                        ...
                        <div class="thumbnails-container-wrapper">
                            <div class="swiper product-thumbnails-swiper">
                                <div class="swiper-wrapper">
                                    @foreach ($order->images as $image)
                                        <div class="swiper-slide">
                                            <img src="{{ asset($image->image_path) }}" alt="صورة مصغرة"
                                ...
                                {{-- أزرار التنقل الخاصة بهذا السلايدر فقط --}}
                                <div class="swiper-button-prev thumbnail-prev"></div>
                                <div class="swiper-button-next thumbnail-next"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row down-swiper">
                        <div class="col-12 col-md-6">
                            <div class="curd">
                                ...
                                <p class="pr my-4"><span>وصف
                                        السلعة:</span>{{ $order->item_specifications ?? 'لا يوجد وصف' }}</p>
                            ...
                            <div class="d-flex gap-2 mt-2">
                                <a href="https://wa.me/{{ $order->whatsapp_number ?? '' }}"
                                    class="flex-fill btn contact-btn whatsapp-btn">
                        ...
                        <div class="col-12 col-md-6 ">
                            <div class="curd">
                                ...
                                <p class="pr"><span>تفاصيل
                                        اخرى:</span>{{ $order->item_specifications ?? 'لا يوجد تفاصيل' }}</p>
                            </div>
                            <div class="d-grid gap-2 ">
                                <a href="https://wa.me/{{ $order->admin_whatsapp_number ?? '' }}"
                                    class="btn contact-btn whatsapp-btn">
                                    <img src="{{ asset('frontend/image/logos_whatsapp-icon.png') }}" alt="WhatsApp Icon">
